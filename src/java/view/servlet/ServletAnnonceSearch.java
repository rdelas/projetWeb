 ...
 * @author rdelas
 */
@WebServlet(name = "ServletAnnonceSearch", urlPatterns = {"/ServletAnnonceSearch"})
public class ServletAnnonceSearch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletAnnonceSearch</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletAnnonceSearch at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        addData(request);
        RequestDispatcher dp = request.getRequestDispatcher("includes/form_search_annonce.jsp");
